...
public class Sms
{
    ...
    //衡道 发往分配员
    public static string Message13(string Phone, string HisName, string DisplayName, string BookContent, string SBookTime)
    {
        string str = "";
        try
        {
            ...
            string PassWord = ConfigurationManager.AppSettings["PassWord"];
            string value = "";
            value = string.Format("" + ConfigurationManager.AppSettings["FrozenReutrn"] + "", HisName, SBookTime, BookContent);
            string url = "http://www.smsbao.com/sms?u=" + UserName + "&p=" + PassWord + "&m=" + Phone + "&c=" + value + "";
            WebClient _WebClient = new WebClient();
            str = _WebClient.DownloadString(url);
        }
    ...
    //衡道发给中心
    public static string Message14(string Phone, string HisName, string BookContent, string SBookTime, string DisplayName)
    {
        string str = "";
        try
        {
            ...
            string PassWord = ConfigurationManager.AppSettings["PassWord"];
            string value = "";
            value = string.Format("" + ConfigurationManager.AppSettings["HDFrozenCenter"] + "", HisName, SBookTime, BookContent, DisplayName);
            string url = "http://www.smsbao.com/sms?u=" + UserName + "&p=" + PassWord + "&m=" + Phone + "&c=" + value + "";
            WebClient _WebClient = new WebClient();
            str = _WebClient.DownloadString(url);
        }
    ...
    //接受预约专家
    public static string Message16(string Phone, string HisName, string BookContent, string SBookTime, string DisplayName)
    {
        string str = "";
        try
        {
            ...
            string PassWord = ConfigurationManager.AppSettings["PassWord"];
            string value = "";
            value = string.Format("" + ConfigurationManager.AppSettings["HDExp"] + "", DisplayName, HisName, SBookTime, BookContent);
            string url = "http://www.smsbao.com/sms?u=" + UserName + "&p=" + PassWord + "&m=" + Phone + "&c=" + value + "";
            WebClient _WebClient = new WebClient();
            str = _WebClient.DownloadString(url);
        }
    ...
    //分配员预约退回至申请端
    public static string Message19(string Phone, string HisName, string BookContent, string SBookTime)
    {
        string str = "";
        try
        {
            ...
            string PassWord = ConfigurationManager.AppSettings["PassWord"];
            string value = "";
            value = string.Format("" + ConfigurationManager.AppSettings["HDYYCenterToHis"] + "", HisName, SBookTime, BookContent);
            string url = "http://www.smsbao.com/sms?u=" + UserName + "&p=" + PassWord + "&m=" + Phone + "&c=" + value + "";
            WebClient _WebClient = new WebClient();
            str = _WebClient.DownloadString(url);
        }
    ...
    //分配员预约退回至申请端 抄送 中心分配员
    public static string Message20(string Phone, string HisName, string BookContent, string SBookTime)
    {
        string str = "";
        try
        {
            ...
            string PassWord = ConfigurationManager.AppSettings["PassWord"];
            string value = "";
            value = string.Format("" + ConfigurationManager.AppSettings["HDYYCenterToHisCC"] + "", HisName, SBookTime, BookContent);
            string url = "http://www.smsbao.com/sms?u=" + UserName + "&p=" + PassWord + "&m=" + Phone + "&c=" + value + "";
            WebClient _WebClient = new WebClient();
            str = _WebClient.DownloadString(url);
        }
